...
export default function App() {
  ...
  const tabContent = (
    <>
      ...
      {!showAdmin && view === 'promos' && <PromosTab month={month} year={year} promos={promos} savePromos={savePromos} priceList={priceList} savePriceList={savePriceList} currentUser={currentUser} />}
